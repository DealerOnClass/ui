...
var Tab = (function ($) {
  ...
  var Selector = {
    ...
    NAV: 'nav',                                             // added
    //FADE_CHILD: '> .nav-item .fade, > .fade',             // changed
    FADE_CHILD: '> .nav-item.fade, > .fade',
    ACTIVE: '.active',
    //ACTIVE_CHILD: '> .nav-item > .active, > .active',     // changed
  ...
  var Tab = (function () {
    ...
    _createClass(Tab, [{
      ...
      value: function show() {
        ...
        var ulElement = $(this._element).closest(Selector.NAV)[0];  // changed, NAV was UL
...
var Popover = (function ($) {
  ...
  var Default = $.extend({}, Tooltip.Default, {
    ...
    trigger: 'click',
    content: '',
    template: '<div class="popover" role="tooltip">' + '<div class="popover-arrow"></div>' + '<h3 class="popover-item popover-title"></h3>' + '<div class="popover-item popover-content"></div></div>'
  });
